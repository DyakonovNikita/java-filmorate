...
CREATE TABLE IF NOT EXISTS friends (
    request_friend_id bigint REFERENCES users(user_id) ON UPDATE RESTRICT ON DELETE CASCADE,
    response_friend_id bigint REFERENCES users(user_id) ON UPDATE RESTRICT ON DELETE CASCADE,
