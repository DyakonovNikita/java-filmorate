...
CREATE TABLE IF NOT EXISTS friends (
    request_friend_id bigint REFERENCES app_users(id) ON UPDATE RESTRICT ON DELETE CASCADE,
    response_friend_id bigint REFERENCES app_users(id) ON UPDATE RESTRICT ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS film_genre (
      ...
      genre_id bigint REFERENCES genres(genre_id) ON UPDATE RESTRICT ON DELETE CASCADE,
      CONSTRAINT FILM_GENRES_PK PRIMARY KEY (film_id, genre_id)
);

CREATE TABLE IF NOT EXISTS likes (
     user_id bigint REFERENCES app_users(id) ON UPDATE RESTRICT ON DELETE CASCADE,
     film_id bigint REFERENCES films(film_id) ON UPDATE RESTRICT ON DELETE CASCADE,
